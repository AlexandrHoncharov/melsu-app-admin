                                            ...
                                            >
                                                <View style={styles.timeContainer}>
                                                    ...
                                                    <View style={styles.timeConnector}>
                                                        <View
                                                            style={[styles.timeLine, isActive && styles.activeTimeLine]}/>
                                                        <View
                                                            style={[styles.timeCircle, isActive && styles.activeTimeCircle]}/>
                                                        <View
                                                            style={[styles.timeLine, isActive && styles.activeTimeLine]}/>
                                                    </View>
                                                    <Text style={[styles.timeText, isActive && styles.activeTimeText]}>
                                                        ...
                                                        <View key={`${lesson.id || lessonIndex}-${lessonIndex}`}>
                                                            ...
                                                            >
                                                                <View style={styles.lessonHeader}>
                                                                    ...
                                                                    >
                                                                        <Text
                                                                            style={styles.lessonTypeText}>{lesson.lessonType}</Text>
                                                                    </View>
                                                                </View>

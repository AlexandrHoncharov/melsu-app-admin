                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.featureItem}>
                        ...
                        <View style={styles.featureTextContainer}>
                            ...
                            <Text style={styles.featureText}>Актуальное расписание занятий для студентов и
                                преподавателей</Text>
                        </View>
                    </View>
                    <View style={styles.featureItem}>
                    ...
                    <View style={styles.featureItem}>
                        ...
                        <View style={styles.featureTextContainer}>
                            ...
                            <Text style={styles.featureText}>Подтверждение статуса студента для доступа ко всем
                                функциям</Text>
                        </View>
                    </View>
                    <View style={styles.featureItem}>

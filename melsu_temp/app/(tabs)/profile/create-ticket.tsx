...
// Категории тикетов
const categories = [
  { value: 'technical', label: 'Техническая проблема', icon: 'hardware-chip-outline', color: '#7B1FA2', bgColor: '#F3E5F5' },
  { value: 'schedule', label: 'Проблема с расписанием', icon: 'calendar-outline', color: '#388E3C', bgColor: '#E8F5E9' },
  { value: 'verification', label: 'Вопрос по верификации', icon: 'shield-checkmark-outline', color: '#1976D2', bgColor: '#E3F2FD' },

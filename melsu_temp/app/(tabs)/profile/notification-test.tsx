      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {pushToken && (
          <View style={styles.section}>
            ...
            >
                {isLoading ? <ActivityIndicator size="small" color="#fff"/> :
                    <Text style={styles.buttonText}>{isRegistered ? 'Re-register Token' : 'Register Token'}</Text>}
            </TouchableOpacity>
          </View>
        )}
        ...
        {lastNotification && (
          <View style={styles.section}>
            ...
            <View style={styles.notificationContainer}>
                <Text style={styles.notificationTitle}>{lastNotification.request?.content?.title || 'No title'}</Text>
                <Text style={styles.notificationBody}>{lastNotification.request?.content?.body || 'No body'}</Text>

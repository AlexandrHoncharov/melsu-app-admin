    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.filterContainer}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.filterScroll}>
          ...
          >
            <Text style={[styles.filterText, activeFilter === 'new' && styles.activeFilterText]}>Новые</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.filterButton, activeFilter === 'in_progress' && styles.activeFilterButton]}
            onPress={() => handleFilter('in_progress')}
          >
            <Text style={[styles.filterText, activeFilter === 'in_progress' && styles.activeFilterText]}>В обработке</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.filterButton, activeFilter === 'waiting' && styles.activeFilterButton]}
            onPress={() => handleFilter('waiting')}
          >
            <Text style={[styles.filterText, activeFilter === 'waiting' && styles.activeFilterText]}>Ожидают</Text>
          </TouchableOpacity>
          <TouchableOpacity
      ...
      {isLoading ? (
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>
            У вас пока нет обращений в техническую поддержку. Создайте новое обращение, если у вас возникли проблемы.
          </Text>
          <TouchableOpacity
